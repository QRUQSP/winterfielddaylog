//
// This is the main app for the winterfielddaylog module
//
function qruqsp_winterfielddaylog_main() {
    this.bandOptions = {
        '160':'160 M', 
        '80':'80 M', 
        '40':'40 M', 
...
//                'onkeyup':'M.qruqsp_winterfielddaylog_main.menu.keyUp',
...
//            },
        '_add':{'label':'', 'aside':'yes', 'buttons':{
            'add':{'label':'Add Contact', 'fn':'M.qruqsp_winterfielddaylog_main.menu.addQSO();'},
            }},
        ...
        '_buttons':{'label':'', 'aside':'yes', 'buttons':{
            'all':{'label':'Contact List', 'fn':'M.qruqsp_winterfielddaylog_main.qsos.open(\'M.qruqsp_winterfielddaylog_main.menu.open();\');'},
            'cabrillo':{'label':'Download Cabrillo', 'fn':'M.qruqsp_winterfielddaylog_main.menu.downloadCabrillo();'},
            'excel':{'label':'Download Excel', 'fn':'M.qruqsp_winterfielddaylog_main.menu.downloadExcel();'},
            }},
...
//            'rowFn':function(i, d) {
//                return 'M.qruqsp_winterfielddaylog_main.qso.open(\'M.qruqsp_winterfielddaylog_main.menu.open();\',\'' + (d != null ? d.id : '') + '\');';
//                },
//            },
        '_tabs':{'label':'', 'type':'paneltabs', 'selected':'qsos', //'panelcolumn':1,
            'visible':function() { return M.size != 'compact' && M.qruqsp_winterfielddaylog_main.menu.uisize == 'normal' ? 'yes' : 'hidden'; },
            'tabs':{
                'qsos':{'label':'Contacts', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'qsos\');'},
//                'areas':{'label':'Sections', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'areas\');'},
                'vareas':{'label':'Sections', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'vareas\');'},
                'map':{'label':'Map', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'map\');'},
                'stats':{'label':'Stats', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'stats\');'},
                'usbandplan':{'label':'US', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'usbandplan\');'},
                'cdnbandplan':{'label':'Canada', 'fn':'M.qruqsp_winterfielddaylog_main.menu.switchTab(\'cdnbandplan\');'},
            }},
//        'search':{'label':'', 'type':'livesearchgrid', 'livesearchcols':1,
//            'visible':function() { return M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'qsos' ? 'yes' : 'hidden'; },
//            'cellClasses':[''],
//            'hint':'Search qso',
//            'noData':'No qso found',
//            },
        'recent':{'label':'Recent Contacts', 'type':'simplegrid', 'num_cols':6, //'panelcolumn':1,
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'qsos' 
            ...
            'noData':'No contacts',
            'addTxt':'Add Contact',
            'addFn':'M.qruqsp_winterfielddaylog_main.qso.open(\'M.qruqsp_winterfielddaylog_main.menu.open();\',0,null);',
            'rowFn':function(i, d) {
                return 'M.qruqsp_winterfielddaylog_main.qso.open(\'M.qruqsp_winterfielddaylog_main.menu.open();\',\'' + (d != null ? d.id : '') + '\');';
                },
            },
        'areas':{'label':'Sections', 'type':'simplegrid', 'num_cols':14, //'panelcolumn':2,
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'areas' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                ? 'yes' : 'hidden'; },
        ...
        'vareas':{'label':'Sections', 'type':'simplegrid', 'num_cols':12, //'panelcolumn':2,
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'vareas' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                ? 'yes' : 'hidden'; },
        ...
        'map':{'label':'Sections Worked Map', 'type':'imageform',
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'map' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                ? 'yes' : 'hidden'; },
            'fields':{
...
/*        'gota_stats':{'label':'GOTA', 'type':'simplegrid', 'num_cols':5,
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'stats' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                && M.qruqsp_winterfielddaylog_main.menu.data.settings['category-operator'] != null 
                && M.qruqsp_winterfielddaylog_main.menu.data.settings['category-operator'] == 'MULTI-OP'
                ? 'yes' : 'hidden'; },
            'cellClasses':['bold', ''],
            'sortable':'yes',
            'sortTypes':['text','number','number','number','number','number','number','number','number','number','number','number','number','number','number'],
        ...
        'usbandplan':{'label':'US Band Plan', 'type':'imageform',
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'usbandplan' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                ? 'yes' : 'hidden'; },
            'fields':{
        ...
        'cdnbandplan':{'label':'Canadian Band Plan', 'type':'imageform',
            'visible':function() { return M.size != 'compact' 
                && (M.qruqsp_winterfielddaylog_main.menu.sections._tabs.selected == 'cdnbandplan' 
                    || M.qruqsp_winterfielddaylog_main.menu.uisize == 'large') 
                ? 'yes' : 'hidden'; },
            'fields':{
    ...
    this.menu.imageURL = function(s, i, d, img_id) {
        //return '/qruqsp-mods/winterfielddaylog/ui/maps/base.jpg';
//        return M.api.getBinaryURL('qruqsp.winterfielddaylog.mapGet', {'tnid':M.curTenantID, 'sections':'ONN,NNY,CO,IA,WI,NM,MS,LA,AR'});
        if( s == 'cdnbandplan' ) {
            return '/qruqsp-mods/winterfielddaylog/ui/cdnbandplan.jpg';
        }
        if( s == 'usbandplan' ) {
            return '/qruqsp-mods/winterfielddaylog/ui/usbandplan.jpg';
        }
        return M.api.getBinaryURL('qruqsp.winterfielddaylog.mapGet', {'tnid':M.curTenantID});
    }
...
/*        M.api.getJSONBgCb('qruqsp.winterfielddaylog.dupSearch', {'tnid':M.curTenantID, 'callsign':this.formValue('callsign')}, function(rsp) {
            var p = M.qruqsp_winterfielddaylog_main.menu;
            if( M.size == 'compact' ) {
    ...
    this.menu.liveSearchCb = function(s, i, v) {
        if( s == 'qso' && v != '' ) {
            M.api.getJSONBgCb('qruqsp.winterfielddaylog.dupSearch', {'tnid':M.curTenantID, 'callsign':v, 'limit':'25'}, function(rsp) {
                M.qruqsp_winterfielddaylog_main.menu.liveSearchShow(s,i,M.gE(M.qruqsp_winterfielddaylog_main.menu.panelUID + '_' + i), rsp.duplicates);
                });
        }
    }
...
/*    this.menu.expandUI = function() {
    ...
    this.menu.refreshMap = function() {
        var url = M.api.getBinaryURL('qruqsp.winterfielddaylog.mapGet', {'tnid':M.curTenantID}) + '&t=' + new Date().getTime();
...
//            || this.data.settings['category-transmitter'] == null || this.data.settings['category-transmitter'] == ''
            ...
            M.api.openFile('qruqsp.winterfielddaylog.exportCabrillo', {'tnid':M.curTenantID});
        }
    }
    this.menu.downloadExcel = function() {
        M.api.openFile('qruqsp.winterfielddaylog.exportExcel', {'tnid':M.curTenantID});
    }
    this.menu.reopen = function(cb) {
        M.api.getJSONCb('qruqsp.winterfielddaylog.get', {'tnid':M.curTenantID}, function(rsp) {
            if( rsp.stat != 'ok' ) {
                M.api.err(rsp);
                return false;
            }
...
//                p.sections.qso.fields.flags1.visible = 'yes';
    ...
    this.menu.addQSO = function() {
        ...
        M.api.postJSONCb('qruqsp.winterfielddaylog.qsoAdd', {'tnid':M.curTenantID}, c, function(rsp) {
            if( rsp.stat != 'ok' ) {
                M.api.err(rsp);
                return false;
            }
...
//            'sortTypes':['date', 'text', 'text', 'text', 'number', 'text'],
            ...
            'noData':'No contacts',
            'addTxt':'Add Contact',
            'addFn':'M.qruqsp_winterfielddaylog_main.qso.open(\'M.qruqsp_winterfielddaylog_main.qsos.open();\',0,null);'
            },
    }
    this.qsos.liveSearchCb = function(s, i, v) {
        if( s == 'search' && v != '' ) {
            M.api.getJSONBgCb('qruqsp.winterfielddaylog.qsoSearch', {'tnid':M.curTenantID, 'start_needle':v, 'limit':'25'}, function(rsp) {
                M.qruqsp_winterfielddaylog_main.qsos.liveSearchShow('search',null,M.gE(M.qruqsp_winterfielddaylog_main.qsos.panelUID + '_' + s), rsp.qsos);
                });
        }
    }
    ...
    this.qsos.rowFn = function(s, i, d) {
        if( s == 'qsos' || s == 'search' ) {
            return 'M.qruqsp_winterfielddaylog_main.qso.open(\'M.qruqsp_winterfielddaylog_main.qsos.open();\',\'' + d.id + '\',M.qruqsp_winterfielddaylog_main.qso.nplist);';
        }
    }
    this.qsos.open = function(cb) {
        M.api.getJSONCb('qruqsp.winterfielddaylog.qsoList', {'tnid':M.curTenantID}, function(rsp) {
            if( rsp.stat != 'ok' ) {
                M.api.err(rsp);
                return false;
            }
            var p = M.qruqsp_winterfielddaylog_main.qsos;
            p.data = rsp;
...
//            'flags1':{'label':'GOTA', 'type':'flagtoggle', 'default':'off', 'bit':0x01, 'field':'flags', 'visible':'no'},
        ...
        '_buttons':{'label':'', 'buttons':{
            'save':{'label':'Save', 'fn':'M.qruqsp_winterfielddaylog_main.qso.save();'},
            'delete':{'label':'Delete', 
                'visible':function() {return M.qruqsp_winterfielddaylog_main.qso.qso_id > 0 ? 'yes' : 'no'; },
                'fn':'M.qruqsp_winterfielddaylog_main.qso.remove();'},
            }},
        };
    this.qso.fieldValue = function(s, i, d) { return this.data[i]; }
    this.qso.fieldHistoryArgs = function(s, i) {
        return {'method':'qruqsp.winterfielddaylog.qsoHistory', 'args':{'tnid':M.curTenantID, 'qso_id':this.qso_id, 'field':i}};
    }
    this.qso.open = function(cb, qid, list) {
        if( qid != null ) { this.qso_id = qid; }
        if( list != null ) { this.nplist = list; }
        M.api.getJSONCb('qruqsp.winterfielddaylog.qsoGet', {'tnid':M.curTenantID, 'qso_id':this.qso_id}, function(rsp) {
            if( rsp.stat != 'ok' ) {
                M.api.err(rsp);
                return false;
            }
            var p = M.qruqsp_winterfielddaylog_main.qso;
            p.data = rsp.qso;
...
//                p.sections.general.fields.flags1.visible = 'yes';
    ...
    this.qso.save = function(cb) {
        if( cb == null ) { cb = 'M.qruqsp_winterfielddaylog_main.qso.close();'; }
        if( !this.checkForm() ) { return false; }
        if( this.qso_id > 0 ) {
            var c = this.serializeForm('no');
            if( c != '' ) {
                M.api.postJSONCb('qruqsp.winterfielddaylog.qsoUpdate', {'tnid':M.curTenantID, 'qso_id':this.qso_id}, c, function(rsp) {
                    if( rsp.stat != 'ok' ) {
                        M.api.err(rsp);
                        return false;
                    }
            ...
            M.api.postJSONCb('qruqsp.winterfielddaylog.qsoAdd', {'tnid':M.curTenantID}, c, function(rsp) {
                ...
                M.qruqsp_winterfielddaylog_main.qso.qso_id = rsp.id;
                eval(cb);
            });
        }
    }
    this.qso.remove = function() {
        M.confirm('Are you sure you want to remove qso?',null,function() {
            M.api.getJSONCb('qruqsp.winterfielddaylog.qsoDelete', {'tnid':M.curTenantID, 'qso_id':M.qruqsp_winterfielddaylog_main.qso.qso_id}, function(rsp) {
                if( rsp.stat != 'ok' ) {
                    M.api.err(rsp);
                    return false;
                }
                M.qruqsp_winterfielddaylog_main.qso.close();
            });
        });
    }
    this.qso.nextButtonFn = function() {
        if( this.nplist != null && this.nplist.indexOf('' + this.qso_id) < (this.nplist.length - 1) ) {
            return 'M.qruqsp_winterfielddaylog_main.qso.save(\'M.qruqsp_winterfielddaylog_main.qso.open(null,' + this.nplist[this.nplist.indexOf('' + this.qso_id) + 1] + ');\');';
        }
        return null;
    }
    ...
    this.qso.addButton('save', 'Save', 'M.qruqsp_winterfielddaylog_main.qso.save();');
    ...
    this.settings.sections = {
        '_station':{'label':'Station Call Sign', 'fields':{
            ...
            'class':{'label':'Class', 'type':'text'},
            'section':{'label':'Section', 'type':'text'},
            'location':{'label':'Location', 'type':'text', 'hint':'Town, State'},
...
/*            'category-station':{'label':'Station', 'type':'toggle', 'default':'FIXED', 'toggles':{'FIXED':'Fixed', 
        ...
        '_buttons':{'label':'', 'buttons':{
            ...
            'clear':{'label':'Clear Contacts', 'fn':'M.qruqsp_winterfielddaylog_main.settings.clearQSOs();'},
            }},
        };
    this.settings.fieldValue = function(s, i, d) { return this.data[i]; }
    this.settings.fieldHistoryArgs = function(s, i) {
        return {'method':'qruqsp.winterfielddaylog.settingsHistory', 'args':{'tnid':M.curTenantID, 'setting':i}};
    }
    this.settings.clearQSOs = function() {
        M.confirm("Are you sure you want to permanently delete all contacts? This is only advised during testing. Once deleted there is noway to recover the contacts.",null,function() {
            M.confirm("Are you really sure you want to delete all contacts?","Yes, Delete Contacts",function() {
                M.api.getJSONCb('qruqsp.winterfielddaylog.qsosDelete', {'tnid':M.curTenantID}, function(rsp) {
                    if( rsp.stat != 'ok' ) {
                        M.api.err(rsp);
                        return false;
                    }
    ...
    this.settings.open = function(cb) {
        M.api.getJSONCb('qruqsp.winterfielddaylog.settingsGet', {'tnid':M.curTenantID}, function(rsp) {
            if( rsp.stat != 'ok' ) {
                M.api.err(rsp);
                return false;
            }
            var p = M.qruqsp_winterfielddaylog_main.settings;
            p.data = rsp.settings;
            p.refresh();
            p.show(cb);
        });
    ...
    this.settings.save = function(cb) {
        if( cb == null ) { cb = 'M.qruqsp_winterfielddaylog_main.settings.close();'; }
        if( !this.checkForm() ) { return false; }
        var c = this.serializeForm('no');
        if( c != '' ) {
            M.api.postJSONCb('qruqsp.winterfielddaylog.settingsUpdate', {'tnid':M.curTenantID}, c, function(rsp) {
                if( rsp.stat != 'ok' ) {
                    M.api.err(rsp);
                    return false;
                }
    ...
    this.settings.addButton('save', 'Save', 'M.qruqsp_winterfielddaylog_main.settings.save();');
    ...
    this.start = function(cb, ap, ag) {
        ...
        this._settings = M.curTenant.modules['qruqsp.winterfielddaylog'].settings;
       
        this.menu.addButton('settings', 'Settings', 'M.qruqsp_winterfielddaylog_main.settings.open(\'M.qruqsp_winterfielddaylog_main.menu.reopen();\');');
        if( M.size == 'compact' ) {
            this.menu.sections.qso.label = '';
        } else {
//            this.menu.addButton('expand', 'Expand', 'M.qruqsp_winterfielddaylog_main.menu.expandUI();');
        }

        //
        // Create the app container
        //
        var ac = M.createContainer(ap, 'qruqsp_winterfielddaylog_main', 'yes');
        if( ac == null ) {
            M.alert('App Error');
            return false;
        }
